...
func GetRandomName() string {
	...
	name := left[r.Intn(len(left))] + "_" + right[r.Intn(len(right))] //nolint:gosec // G404: Use of weak random number generator (math/rand instead of crypto/rand)
